...
#Utilisation de l'api de yt (youtube DATA v3) pour uploader une vidéo, pb, seulement le droit à 6 vidéo par jour => quota yt de ses mort...
# pour le run, utiliser cette comande : sh upload_video.sh
